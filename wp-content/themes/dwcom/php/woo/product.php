					...
					<div class="info__right">
                        ...
                        <div class="product__action">
                            ...
                            <div class="product__purchase">
                                ...
                                <button class="btn btn-green-outline" type="button" id="addToCartButton" data-product-name="<?php the_title() ?>" data-product-id="<?php echo esc_attr($product->get_id()); ?>">
                                    <span>
                        ...
                        <div class="product__tabs">
                            <div class="tabs fs24 color-green weight-500">
                                <div class="item active productTabItem" data-tab="compound">Состав</div>
